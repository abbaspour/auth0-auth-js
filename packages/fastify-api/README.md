...
![Release](https://img.shields.io/npm/v/@auth0/fastify-api)
![Downloads](https://img.shields.io/npm/dw/@auth0/fastify-api)
...
- [Examples](https://github.com/auth0/auth0-server-js/blob/main/packages/fastify-api/EXAMPLES.md) - examples for your different use cases.
...
```ts
declare module '@auth0/fastify-api' {
  interface Token {
    id: number;
    name: string;
    age: number;
